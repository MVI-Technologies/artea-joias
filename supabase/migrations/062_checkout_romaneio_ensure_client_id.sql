-- Migration 062: Garantir que o romaneio sempre tenha client_id ao adicionar/atualizar pelo carrinho
-- Assim "Qtd peças compradas" e "X pessoas" refletem corretamente quem já comprou.
...
BEGIN
    ...
    IF v_existing_id IS NOT NULL THEN
        ...
        -- Garantir client_id no UPDATE para que "X pessoas" e lista de compradores fiquem corretos
        UPDATE romaneios
        SET 
...
COMMENT ON FUNCTION checkout_romaneio IS 'Checkout por lote: identifica o cliente (client_id) para que "Qtd peças compradas" e lista de compradores reflitam corretamente quem já comprou.';
